...
// dot_genie
IntegerVector dot_genie(NumericMatrix mst, int k, double gini_threshold, bool verbose);
RcppExport SEXP _genieclust_dot_genie(SEXP mstSEXP, SEXP kSEXP, SEXP gini_thresholdSEXP, SEXP verboseSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    ...
    rcpp_result_gen = Rcpp::wrap(dot_genie(mst, k, gini_threshold, verbose));
    return rcpp_result_gen;
END_RCPP
}
// dot_gclust
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_genieclust_dot_genie", (DL_FUNC) &_genieclust_dot_genie, 4},
