...
The out-of-the-box Genie algorithm generates pretty meaningful partitions.

As with all distance-based methods (this includes
[k-means and DBSCAN](https://scikit-learn.org/stable/auto_examples/cluster/plot_cluster_comparison.html) as well),
