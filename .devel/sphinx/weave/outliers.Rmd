...
```{python noise-Genie3,results="hide",fig.cap="Labels predicted by Genie when outliers were removed from the dataset – different number of clusters requested",fig.height=5.9375}
ncs = [3, 6, 8, 10]
