...
```{python noise-Genie1,results="hide",fig.cap="Labels predicted by Genie with outliers detected by Deadwood",fig.height=3}
Ms = [10, 25]
...
# Scatter plot:
deadwood.plot_scatter(X, labels=labels_genie, alpha=0.5)
...
```{python noise-Genie3,results="hide",fig.cap="Labels predicted by Genie with outliers removed by Deadwood: Different number of clusters requested",fig.height=5.9375}
ncs = [3, 6, 8, 10]
