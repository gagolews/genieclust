...
opts_chunk$set(
    fig.path='figures_sklearn_toy_example/',
    cache.path='cache_sklearn_toy_example/',
    autodep=FALSE,
...
```{python imports2,results="hide",echo=FALSE}
...
```{python clustering,results="hide",fig.cap="Outputs of different clustering algorithms"}
