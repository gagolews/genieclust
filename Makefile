...
py-check: python
	...
	flake8 . --count --exit-zero --max-complexity=10 --ignore=E121,E123,E126,E226,E24,E704,W503,W504,E221,E303 --max-line-length=127 --statistics  --exclude=devel,build,docs,.git,R,dist,genieclust.egg-info,man,tutorials
